...
#cclass = "cancermap_cluster_27_vs_29" #: 7" #"annotated_class_MM_vs_CML"#cancermap_cluster_CellLine_Leukemia_and_Cancer_Myeloma"
ddb = None

#add map type here to make it more generic, set path, *_pwpw_, ...

if (source == "gexp"):
	ddb = aml_pwpw_gexp.aml_pwpw_gexp[cclass]
if (source == "clin"):
        ddb = aml_pwpw_clin.aml_pwpw_clin[cclass]
if (source == "drug"):
        ddb = aml_pwpw_drug.aml_pwpw_drug[cclass]
if (source == "gsva"):
        ddb = aml_pwpw_gsva.aml_pwpw_gsva[cclass]
...
conn1 = sqlite3.connect('sqlite/aml_pwpw_'+source+'%i.db' %ddb)
c1 = conn1.cursor()
