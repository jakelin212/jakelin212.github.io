...
#gexppwdbdic = {'cancermap_cluster_27_vs_28'
#[_pwpw_'+source+'_' + cclass + '] (featurea text, featureb text, coeff real, n_samples int, pv real, bh1 real, corrpv real, nnaa int, diffa int, nnab int, diffb int
