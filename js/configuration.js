...
function setSettings(){
	...
	pwpwfdr = $("#pwpwfdr").val();
        mpratio = $("#mpratio").val();
        hexpmapwidth = mpratio.split(":")[0];
	hexptblwidth = mpratio.split(":")[1];
	if (parseInt(hexpmapwidth) + parseInt(hexptblwidth) > 100){
		new Messi('Width ratios must add to <= 100.', {title:"Error"});;
		return;
	}
	if ($("#hexpmenu") != null){
