...
function add2GEXP(){
	...
	if (col == "gsms"){
	   ...
	   new Messi('Sample group ' + gkey + ' defined. Add more or go to Boxplot to assign to genes', {title:"Success", autoclose:1500});
		...
		/*	
	   $( "#gexp_dialog" ).html("Calculating...<img src='http://jakelin212.github.io/images/progress.gif' />");
		$.ajax({
                type: "POST",
...
//$('#SNP').html( rawdata + '<br>' + columns + searchin + button + '<br><table cellpadding="0" cellspacing="0" border="0" class="display" id="snptable"></table>' );
	...
	$( "#snp_dialog" ).html("<img src='http://jakelin212.github.io/images/progress.gif' />");
	$.ajax({
                type: "POST",
...
function greyBg(){
	$( "#grey_dialog" ).html("<img src='http://jakelin212.github.io/images/progress.gif' />");
